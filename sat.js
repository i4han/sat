...
Sat = {
    init: function () {
        ...
        if ( Meteor.isServer ) {
            ...
            //console.log( module.exports.__client__ );
            //_.extend( __, module.exports.__client__ ); 
            ...
            _.each(_.keys(Page), function(file) {
                if (Page[file].__events__ && Page[file].__events__.startup)
                    return startup.push(Page[file].__events__.startup);
            });        
            Meteor.startup(function() {
                return _.each(startup, function(func) { return func(); });
            });
        } 
